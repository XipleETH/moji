...
export const CONTRACT_ADDRESSES = {
  ...
  // ⚡ CONTRATO AVALANCHE FUJI - SORTEOS CADA HORA - TIMING CORREGIDO ⚡
  LOTTO_MOJI_CORE: "0x900ebdF6C0807E4d3007e07009BDeDFc5E63fbB1", // Fuji: SORTEOS HORARIOS + TIMING FIXED + VRF OK
...
export const GAME_CONFIG = {
  ...
  USDC_DECIMALS: 6,
  DRAW_TIME_UTC: 'HOURLY', // ⚡ SORTEOS CADA HORA - TESTING MODE
