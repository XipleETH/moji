...
export const CONTRACT_ADDRESSES = {
  ...
  // 🎯 CONTRATO AVALANCHE FUJI V4 - SORTEOS DIARIOS 5:00 UTC + VRF V2PLUS + ERC721ENUMERABLE 🎯
  LOTTO_MOJI_CORE: "0xe1eF53748D9a30Dd89DF5f1E6df6C3Fc2c339008", // Fuji: SORTEOS DIARIOS 5:00 UTC + VRF V2Plus + ERC721Enumerable + 10-100x faster
  ...
  LEGACY_LOTTO_MOJI_CORE_V4_4UTC: "0x19d6c7dc1301860C4E14c72E4338B62113059471", // Fuji: V4 con 4:00 UTC + VRF V2 (anterior)
  LEGACY_LOTTO_MOJI_CORE_V4_WRONG_SUB2: "0xb73c3F8a0a9c2F1cd035454da027a0Abd7350C92", // Fuji: V4 con subscription ID incorrecto 2 (anterior)
  LEGACY_LOTTO_MOJI_CORE_V4_WRONG_SUB: "0x751e56D649c3BEab3de47209B8CE71F8F276abAD", // Fuji: V4 con subscription ID incorrecto (anterior)
  LEGACY_LOTTO_MOJI_CORE_V3_2UTC: "0x250af59d8E4dd4bf541c7D4c3fBD9C0726C6d822", // Fuji: SORTEOS DIARIOS 2:00 UTC + VRF V3 (anterior)
...
export const GAME_CONFIG = {
  ...
  USDC_DECIMALS: 6,
  DRAW_TIME_UTC: '5:00 UTC', // 🎯 SORTEOS DIARIOS A LAS 5:00 UTC
