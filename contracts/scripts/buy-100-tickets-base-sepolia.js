...
async function main() {
    console.log("🔷 COMPRANDO 100 TICKETS EN BASE SEPOLIA");
        ...
        for (let i = 0; i < currentBatch.length; i++) {
            ...
            try {
                ...
                const buyTx = await contract.buyTicket(combination, {
                    gasLimit: 500000 // Gas limit para Base Sepolia
                });
    ...
    console.log("\n" + "=".repeat(60));
    console.log("🔷 COMPRA DE 100 TICKETS EN BASE SEPOLIA COMPLETADA");
}
